...
import 'package:flutter_hotelconcept/sliding_bottom_sheet_content.dart';
...
class _SlidingBottomSheetState extends State<SlidingBottomSheet> with SingleTickerProviderStateMixin{
              ...
              child: Scaffold(
                ...
                body: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.vertical(top: radiusAnimatedValue)),
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
      ...
      double bottomSheetUpdatedValue=bottomSheetController.value-dragSpeedToScreenSizeRatio;
